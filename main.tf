...
module "docdb" {
  source = "git::https://github.com/sameeryalla/tf-module-docdb.git"
...
module "rds" {
  source = "git::https://github.com/sameeryalla/tf-module-rds.git"
...
module "elasticache" {
  source = "git::https://github.com/sameeryalla/tf-module-elasticache.git"
...
module "rabbitmq" {
  source = "git::https://github.com/sameeryalla/tf-module-amazon-mq.git"
...
module "alb" {
  source = "git::https://github.com/sameeryalla/tf-module-alb.git"
